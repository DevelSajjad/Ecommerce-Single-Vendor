            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo e(route('checkout')); ?>"><i class="icon fa fa-check"></i><?php echo e((session()->get('language') == 'english') ? 'Checkout' : 'চেকআউট'); ?></a></li>
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="icon fa fa-check"></i><i class="icon fa fa-lock"></i><?php echo e((session()->get('language') == 'english') ? 'Logout' : 'লগআউট'); ?></a></li>
                            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                            </form>
                            <?php else: ?>
                            <li><a href="<?php echo e(route('login')); ?>"><i class="icon fa fa-lock"></i><?php echo e((session()->get('language') == 'english') ? 'Login/Register' : 'লগিন/রেজিস্টার'); ?></a></li>
                        <?php endif; ?>
                        ...
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw">
                                    <a href="<?php echo e(url('/')); ?>" data-hover="dropdown" class="dropdown-toggle" ><?php echo e((session('language') == 'english') ? 'Home' : 'হোম'); ?></a>
                                </li>
                                <?php
            ...
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li class="first"><a href="#" title="Contact us"><?php echo e((session()->get('language') == 'english') ? 'My Account' : 'প্রোফাইল'); ?></a></li>
                <li><a href="#" title="About us"><?php echo e((session()->get('language') == 'english' ? 'Order History' : 'আমার অডার')); ?></a></li>
                <li><a href="#" title="faq"><?php echo e((session()->get('language') == 'english' ? 'FAQ' : 'এফএকিউ')); ?></a></li>
                <li><a href="#" title="Popular Searches"><?php echo e((session()->get('language') == 'english' ? 'Specials' : 'বিশেষ')); ?></a></li>
                <li class="last"><a href="#" title="Where is my order?"><?php echo e((session()->get('language') == 'english' ? 'Help Center' : 'সাহা্য্য কেন্দ্র')); ?></a></li>
                        </ul>
                    </div><!-- /.module-body -->
                </div><!-- /.col -->
