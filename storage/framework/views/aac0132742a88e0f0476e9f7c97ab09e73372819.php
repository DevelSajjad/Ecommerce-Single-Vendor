...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('/')); ?>backend/lib/medium-editor/default.css" rel="stylesheet">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <?php echo $__env->make('admin.include.leftbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ########## END: LEFT PANEL ########## -->
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
          <div class="media-list">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="<?php echo e(asset('/')); ?>backend/img/img3.jpg" class="wd-40 rounded-circle" alt="">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="<?php echo e(asset('/')); ?>backend/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="<?php echo e(asset('/')); ?>backend/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="<?php echo e(asset('/')); ?>backend/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
          ...
          <div class="media-list">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="<?php echo e(asset('/')); ?>backend/img/img8.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="<?php echo e(asset('/')); ?>backend/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="<?php echo e(asset('/')); ?>backend/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
    ...
    <script src="<?php echo e(asset('/')); ?>backend/lib/spectrum/spectrum.js"></script>
    <script>
      $(function(){
    ...
    <script>
      ...
      <script src="<?php echo e(asset('/')); ?>backend/lib/sweetalert/sweetalert.min.js"></script>
...
<?php /**PATH G:\BITM\wamp\www\Laravel\Ecom\Ecommerce-Single-Vendor\resources\views/admin/master.blade.php ENDPATH**/ ?>