    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        <ul class="nav">
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true"></i><?php echo e((session()->get('language') == 'english') ? $category->category_name_en : $category->category_name_bn); ?></a>
                 <ul class="dropdown-menu mega-menu">
					<li class="yamm-content">
						<div class="row">
							
							<?php $__currentLoopData = $category->subCategories()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-sm-12 col-md-3">
									...
									<ul class="links list-unstyled">
										<?php $__currentLoopData = $subcategory->subSubCategories()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subsubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="item">
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="<?php echo e(asset('/')); ?>fontend/assets/images/hot-deals/p25.jpg" alt="">
							</div>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="<?php echo e(asset('/')); ?>fontend/assets/images/hot-deals/p5.jpg" alt="">
							</div>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="<?php echo e(asset('/')); ?>fontend/assets/images/hot-deals/p10.jpg" alt="">
							</div>
							<div class="sale-offer-tag"><span>35%<br>off</span></div>
							<div class="timing-wrapper">
								<div class="box-wrapper">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p30.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p29.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p28.jpg" alt="">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p15.jpg"  alt="">
						</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p18.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p17.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p16.jpg" alt="">
									</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p14.jpg"  alt="">
						<div class="zoom-overlay"></div>
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p13.jpg" alt="">
					</a>
				</div><!-- /.image -->
...
<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
	<div id="advertisement" class="advertisement">
        <div class="item">
            <div class="avatar"><img src="<?php echo e(asset('/')); ?>fontend/assets/images/testimonials/member1.png" alt="Image"></div>
		<div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
		<div class="clients_author">John Doe	<span>Abc Company</span>	</div><!-- /.container-fluid -->
        </div><!-- /.item -->

         <div class="item">
         	<div class="avatar"><img src="<?php echo e(asset('/')); ?>fontend/assets/images/testimonials/member3.png" alt="Image"></div>
		<div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
		<div class="clients_author">Stephen Doe	<span>Xperia Designs</span>	</div>
        </div><!-- /.item -->

        <div class="item">
            <div class="avatar"><img src="<?php echo e(asset('/')); ?>fontend/assets/images/testimonials/member2.png" alt="Image"></div>
		<div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="<?php echo e(url('single-product-detail',$product->id)); ?>"><img  src="<?php echo e(asset($product->product_thumbnail)); ?>" alt=""></a>
									</div><!-- /.image -->
										<?php
								...
								<div class="product-info text-left">
									<h3 class="name"><a href="detail.html"><?php echo e((session()->get('language') == 'english') ? $product->product_name_en : $product->product_name_bn); ?></a></h3>
									<div class="rating rateit-small"></div>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p5.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p6.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/blank.gif" data-echo="assets/images/products/p7.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p8.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p9.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?php echo e(asset('/')); ?>fontend/assets/images/products/p10.jpg" alt=""></a>
			</div><!-- /.image -->
