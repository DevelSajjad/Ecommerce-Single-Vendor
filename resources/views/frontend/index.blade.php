    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        <ul class="nav">
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true"></i>{{ $category->category_name_en }}</a>
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="{{ asset('/') }}fontend/assets/images/hot-deals/p25.jpg" alt="">
							</div>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="{{ asset('/') }}fontend/assets/images/hot-deals/p10.jpg" alt="">
							</div>
							<div class="sale-offer-tag"><span>35%<br>off</span></div>
							<div class="timing-wrapper">
								<div class="box-wrapper">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p30.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p29.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p28.jpg" alt="">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p15.jpg"  alt="">
						</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p18.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p17.jpg" alt="">
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p16.jpg" alt="">
									</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p14.jpg"  alt="">
						<div class="zoom-overlay"></div>
					</a>
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{ asset('/') }}fontend/assets/images/products/p13.jpg" alt="">
					</a>
				</div><!-- /.image -->
...
<div id="hero">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		...
		<div class="item" style="background-image: url({{ asset('/') }}fontend/assets/images/sliders/01.jpg);">
		...
		<div class="item" style="background-image: url({{ asset('/') }}fontend/assets//images/sliders/02.jpg);">
			<div class="container-fluid">
				<div class="caption bg-color vertical-center text-left">
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p4.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p29.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p5.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p6.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p7.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p8.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p9.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p10.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p11.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p12.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p13.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{ asset('/') }}fontend/assets/images/products/p14.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p15.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{ asset('/') }}fontend/assets/images/products/p16.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{ asset('/') }}fontend/assets/images/products/p18.jpg" alt=""></a>
			</div><!-- /.image -->
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/products/p17.jpg" alt=""></a>
			</div><!-- /.image -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('/') }}fontend/assets/images/blank.gif" data-echo="assets/images/products/p7.jpg" alt=""></a>
			</div><!-- /.image -->
