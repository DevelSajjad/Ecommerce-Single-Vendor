...
<div class="sidebar-widget outer-bottom-small wow fadeInUp">
	...
	<div class="sidebar-widget-body outer-top-xs">
			<div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
				@foreach ($specialOffer as $products)
				<div class="item">
								...
								<div class="row product-micro-row">
									<div class="col col-xs-5">
										<div class="product-image">
											<div class="image">
												<a href="{{ url('single-product-detail',$product->id.'/'.$product->product_slug_en) }}">
...
<div class="sidebar-widget outer-bottom-small wow fadeInUp">
	...
	<div class="sidebar-widget-body outer-top-xs">
		<div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
			@foreach ($specialDeals as $products)
				<div class="item">
					<div class="products special-product">
						@foreach ($products as $product)
							<div class="product">
				...
				<div class="container-fluid">
					<div class="caption bg-color vertical-center text-left">
						...
						<div class="big-text fadeInDown-1">
							{{ (session()->get('language') == 'english') ? $slider->title_en : $slider->title_bn }}
						</div>
						<div class="excerpt fadeInDown-2 hidden-xs">
						<span>{{ (session()->get('language') == 'english') ? $slider->description_en : $slider->description_bn }}</span>
						</div>
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	<div class="more-info-tab clearfix ">
	    <h3 class="new-product-title pull-left">{{ (session()->get('language') == 'english') ? 'New Products ' : 'নতুন প্রোডাক্ট'  }}</h3>
		<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
			<li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">All</a></li>
			@foreach ($categories as $category)
				<li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">{{ (session()->get('language') == 'english') ? $category->category_name_en : $category->category_name_bn }}</a></li>
			@endforeach
							...
							<div class="product">
								<div class="product-image">
									...
									@php
										...
										$dis = 100 - $per;	
									@endphp
									<div class="tag new"><span>@if ($product->discount_price == null) new @else {{ (session()->get('language') == 'english') ? round($dis).'%' : priceBn(round($dis)).'%' }} @endif</span></div>
								</div><!-- /.product-image -->
									...
									<div class="action">
										<ul class="list-unstyled">
											<li class="add-cart-button btn-group">
												<button class="btn btn-primary icon" type="button" id="{{ $product->id }}" onclick="productView(this.id)" data-toggle="modal" data-target="#cartModal" title="Add Cart">
													<i class="fa fa-shopping-cart"></i>
												</button>
												<button class="btn btn-primary cart-btn" type="button" >Add to cart</button>
											</li>
											<li class="add-cart-button btn-group">
												<button data-toggle="tooltip" id="{{ $product->id }}" onclick="addtoWishlist(this.id)" class="btn btn-primary icon" type="button" title="Add Wishlit">
									...
									<div class="cart clearfix animate-effect">
										<div class="action">
											<ul class="list-unstyled">
												...
												<li class="add-cart-button btn-group">
													<button class="btn btn-primary icon" id="{{ $product->id }}" onclick="addWishlist(this.id)" data-toggle="dropdown" type="button">
														<i class="fa fa-heart"></i>
													</button>
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">{{ (session()->get('language') == 'english') ? 'Featured products' : 'ফিচার প্রোডাক্ট' }}</h3>
			...
			<div class="item item-carousel">
				<div class="products">
					<div class="product">
						<div class="product-image">
							<div class="image">
								<a href="{{ url('single-product-detail',$featured->id.'/'.$featured->product_slug_en ) }}"><img  src="{{ asset($featured->product_thumbnail) }}" alt=""></a>
							</div><!-- /.image -->
						...
						<div class="product-info text-left">
							...
							<div class="product-price">
								<span class="price">TK {{ (session()->get('language') == 'english') ? $featured->selling_price : priceBn($featured->selling_price) }}</span>
								<span class="price-before-discount">TK {{ (session()->get('language') == 'english') ? $featured->discount_price : priceBn($featured->discount_price) }}</span>
							</div><!-- /.product-price -->
						</div><!-- /.product-info -->
						<div class="cart clearfix animate-effect">
							<div class="action">
								<ul class="list-unstyled">
									<li class="add-cart-button btn-group">
										<button class="btn btn-primary icon" id="{{ $featured->id }}" onclick="productView(this.id)" type="button" title="Cart" data-toggle="modal" data-target="#cartModal">
											<i class="fa fa-shopping-cart"></i>
										</button>
										<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
									</li>
									...
									<li class="add-cart-button btn-group">
										<button class="btn btn-primary icon" id="{{ $featured->id }}" onclick="addtoWishlist(this.id)" title="Wishlist" type="button" >
											<i class="fa fa-heart"></i>
										</button>
										<button class="btn btn-primary cart-btn" type="button">Add to Wishlist</button>
									</li>
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								<ul class="list-unstyled">
									...
									<li class="add-cart-button btn-group">
										<button class="add-to-cart" id="{{ $product->id }}" onclick="addtoWishlist(this.id)" type="button" title="Wishlist">
											<i class="icon fa fa-heart"></i>
										</button>
									</li>
					...
					<div class="product">
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								<ul class="list-unstyled">
									<li class="add-cart-button btn-group">
										<button class="btn btn-primary icon" id="{{ $product->id }}" onclick="productView(this.id)" type="button" title="Cart" data-toggle="modal" data-target="#cartModal">
											<i class="fa fa-shopping-cart"></i>
										</button>
										<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
									</li>
